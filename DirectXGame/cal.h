...
#pragma region Add3
static Vector3 Add3(const Vector3& v1, const Vector3& v2, const Vector3& v3) { return {v1.x + v2.x + v3.x, v1.y + v2.y + v3.y, v1.z + v2.z + v3.z}; }
#pragma endregion
...
static Vector3 MultiplyVF(const Vector3& v, float scalar) { return {v.x * scalar, v.y * scalar, v.z * scalar}; }
#pragma endregion
